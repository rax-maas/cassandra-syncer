...
function Manifest(source) {
  this._source = source;
  this._resolvedSource = path.resolve(this._source);
  this._initManifest();
}


Manifest.prototype._relativeFilename = function(file) {
  return path.relative(this._resolvedSource, file);
};
...
Manifest.prototype.get = function(file) {
  return this._manifest.files[this._relativeFilename(file)];
};
...
Manifest.prototype.add = function(file, size) {
  ...
  this._manifest.files[this._relativeFilename(file)] = size;
};
...
Manifest.prototype.contains = function(file) {
  return this._manifest.files[this._relativeFilename(file)] !== undefined;
};
