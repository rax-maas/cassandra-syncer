...
Manifest.createDelta = function(manifestA, manifestB) {
  var m = new Manifest(), aKeys = [], bKeys = [];

  Object.keys(manifestA._manifest).forEach(function(file) {
  ...
  aKeys.forEach(function(key) {
    m._manifest[key] = manifestA._manifest[key];
  });
...
Manifest.prototype.contains = function(file) {
  ...
  return this._manifest.files[file] !== undefined;
};
