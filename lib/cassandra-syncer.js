...
SyncMaster.prototype.run = function() {
  ...
  this.manifest = new Manifest(this._options.source, self._re);
  this._target = new T(target, this._backupDir, this._options);
  this._fw = new FileWatcher(this._options.source, self._re);
  this._fw.on('file', function(file) {
