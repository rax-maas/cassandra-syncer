...
Target.prototype._filePath = function(filename) {
  return path.relative(this._options.source, filename);
};

Target.prototype.getLocalFilePath = function(filename) {
  return path.join(this._options.source, filename);
};
...
Target.prototype.getStats = function(filename, callback) {
  throw new Error('you must implement this interface in your child class');
};
